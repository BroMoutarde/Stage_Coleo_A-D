...
```{r}
# PASSER LE DIAMETRE EN METRE (x 0.01)
# Ne pas oublier de rapporter à l'hectare puis comparer les valeurs surfaces terrières (50000m2/ha abbérant)
...
G_plac <- G_plac %>% left_join(G_DMH, G_plac, by=c("placette")) ; G_DMH # joint
...
rAPPORTER A 30 M + RAPPORTER A HECTARE ?
...
# EXPORT
write.table(x = BMP_PlacetteTot5, file = "//no-datafile.inra.local/Biodiversite/projets/Bois_mort/Canopee/These_Balvay/Stagiaires/Adrien Debout - 03-02 au 01-08-2025/Data/Metriques_BMPtot_Placettes_AD.csv", row.names = FALSE, dec=".", sep=";")
```
