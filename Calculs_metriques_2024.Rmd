...
placette_Canopix <- read.table("placette_Canopix.csv", sep=";", dec=",", header=TRUE, stringsAsFactors = FALSE)
  # IMPORT 
placette_Canopix2 <- read.table("placette_Canopix_DMH.csv", sep=";", dec=",", header=TRUE, stringsAsFactors = FALSE)
...
#### CHANGER LA DEFINITION DES STRATES
...
### CHECK PAR RAPPORT AUX NOUVELLES STRATES CANOPEE ET UNDERSTORY SI CA CORRESPOND ###
