...
BMtot <- metrique_BMtot %>%
  ...
  group_by(placette) %>%
  summarise(Proportion_BM = (((Vol_BMP_Tot_Pondere.m3.ha + Vol_BMD_Mtot.m3.ha) / BMtot.m3.ha) * 100))
  


### a expliquer avec plus de détails ###
...
DivBMS2 <- DivBM %>%
  ...
  filter(!is.na(Code_DivBMS)) %>%
  select(1, 12)
  # joindre BMS ET BMS2 PUIS faire le group by 
